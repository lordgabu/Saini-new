...
photologo = 'https://tinypic.host/image/2ggbw' #https://tinypic.host/image/2ggbw
photoyt = 'https://tinypic.host/image/2ggbw' #https://tinypic.host/image/2ggbw
photocp = 'https://tinypic.host/image/2ggbw'
photozip = 'https://tinypic.host/image/2ggbw'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/gabubots")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/gabubots"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/hek0r")],
    ]
)
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://tinypic.host/image/2ggbw",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/new")],
        ])
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://tinypic.host/image/2ggbw",
      caption=caption
    ),
    reply_markup=keyboard
    )
